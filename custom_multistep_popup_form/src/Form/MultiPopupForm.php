...
namespace Drupal\custom_multistep_popup_form\Form;
...
/**
 * Class MultiPopupForm.
 */
class MultiPopupForm extends FormBase {
  ...
  public function getFormId() {
    return 'multistep_popup_form_id';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['#attached']['library'][] = 'custom_multistep_popup_form/multistep_form';
    return $form;
