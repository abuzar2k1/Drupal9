...
namespace Drupal\custom_rest_resource_api\Plugin\rest\resource;
 ...
 *   uri_paths = {
 *     "canonical" = "/custom-get-rest-api"
 *   }
 * )
 */
class GetRestResourceApi extends ResourceBase {
  /**
  ...
  public function get() {
    ...
    // Terms
    $vid = 'fruits'; // vocabulary machine-name
    ...
    $container = array(
      'isSuccess' => 'True',
      'code' => '200',
      'message' => 'Node and Term details',
      'data' => [ 'Node' => $node_result, 'Terms' => $term_result ]
    );

    $response = new ResourceResponse($container);
    $response->addCacheableDependency($container);
    return $response;
